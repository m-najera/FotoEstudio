Public Class detallesAlbum
    ...
    Private Sub detallesAlbum_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim data As DataSet
        data = conexion.obtenerDetallesAlbum(idAlbum)
        txtDetalles.Text = data.Tables(0).Rows(0).Item(2)
        txtCantidadFotos.Text = data.Tables(0).Rows(0).Item(3)
        txtDiseño.Text = data.Tables(0).Rows(0).Item(4)
